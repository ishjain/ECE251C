...
% plot(n(idx4),g(idx4),'ro')
% text(n(idx1),g(idx1)+0.1,sprintf('g(%d) = %d',n(idx1),g(idx1)))
% text(n(idx2),g(idx2),sprintf('g(%d) = %d',n(idx2),g(idx2)))
% text(n(idx3),g(idx3)+0.2,sprintf('g(%d) = %d',n(idx3),g(idx3)))
% text(n(idx4),g(idx4)-0.1,sprintf('g(%d) = %d',n(idx4),g(idx4)))
% hold off
% xlabel('Sample index')
% ylabel('Amplitude')
